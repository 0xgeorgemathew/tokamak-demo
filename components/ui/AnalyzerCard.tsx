...
export function AnalyzerCard({
  ...
  return (
    <div
      className="w-full max-w-5xl glass-border-gradient rounded-3xl overflow-hidden transition-all duration-500"
      style={{
        backdropFilter: "blur(24px) saturate(150%)",
        background:
          "radial-gradient(ellipse at top, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.02) 100%), rgba(3,0,20,0.6)",
        boxShadow: "0 16px 48px rgba(100,80,200,0.1)",
      }}
    >
      <div
        className="h-12 px-6 border-b border-white/10 flex items-center"
        style={{
          background:
      ...
      <div className="flex" style={{ height: "420px" }}>
        <div
          className="w-64 border-r border-white/10 p-6 space-y-2 flex flex-col"
          style={{
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at center top, rgba(255,255,255,0.01) 0%, transparent 70%)",
          }}
        >
          <TransactionInput
            value={inputValue}
